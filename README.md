# dnanexus_ED_cnv_analysis_v1.7.2
...
A Docker image containing Exome depth is downloaded from 001 - The image is taken from https://github.com/moka-guys/seglh-cnv/releases/tag/v2.3.1
