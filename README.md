# dnanexus_ED_cnv_analysis_v1.7.0
...
- Optional: list of comma separated samples to run a specific sample or a list of samples only. Use the sample name before the Pan number (e.g. NGS629-01-xxxxxx-NA12878-U-VCP2R208ViaGP08,NGS629-02-xxxxxx-NA12878-U-VCP2R208ViaGP08)
